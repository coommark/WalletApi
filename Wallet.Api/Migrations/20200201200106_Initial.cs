        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    AccountNumber = table.Column<string>(type: "nvarchar(32)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomerAccount_AccountType_AccountTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerAccountStatus", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomerAccountStatus_CustomerAccount_CustomerAccountId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerAccount_AccountTypeId",
                table: "CustomerAccount",
                column: "AccountTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerAccount_ApplicationUserId",
                table: "CustomerAccount",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerAccountStatus_CustomerAccountId",
                table: "CustomerAccountStatus",
